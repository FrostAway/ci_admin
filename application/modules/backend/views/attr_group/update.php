            ...
            <div class="small-6 medium-6 large-6 large-offset-1 columns">
                ...
                <table id="data-table" class="data-table">
                    ...
                    <tr class="item-row">
                            ...
                            <td>
                                <a href="<?php echo base_url() ?>backend/attribute/edit_attr" class="item-edit fi-pencil large" itemid="<?php echo $attr['id'] ?>" data-tooltip aria-haspopup="true" class="has-tip" title="Chỉnh sửa"></a> 
