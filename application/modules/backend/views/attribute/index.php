        ...
        <table class="data-table">
            ...
            <?php foreach ($attrgs as $attrg) { ?>
                <tr>
                    ...
                    <td>
                        <a href="<?php echo base_url().'backend/attribute/edit_group/'.$attrg['id'] ?>" data-tooltip aria-haspopup="true" class="has-tip" title="Chỉnh sửa"><i class="fi-pencil large"></i> </a> 
